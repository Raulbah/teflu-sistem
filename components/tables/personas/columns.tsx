    ...
    return (
        <>
            ...
            <DeleteConfirmation 
                ...
                title={`¿Dar de baja a ${persona.nombres}?`}
                description="El usuario pasará a estado inactivo y perderá el acceso al sistema inmediatamente."
            />
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    {permissions.canDelete && (
                        <DropdownMenuItem 
                            onClick={() => setShowDeleteAlert(true)} // <-- AHORA
